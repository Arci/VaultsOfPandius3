...
echo "----> STORIES <----";
extractFirstPage('stories.html', $db, $dom, $domHTML);
//extractIndex('atlas.html', $db, $dom, $domHTML);
...
function extractFirstPage($iref, $db, $dom, $domHTML){
  ...
  // inserisco la prima pagina
      ...
      $nodes = $xpath->query("//blockquote/blockquote[position()=1]/a", $domHTML->documentElement);
      //echo $nodes->length;
